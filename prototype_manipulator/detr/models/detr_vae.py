...
class DETRVAE(nn.Module):
    ...
    def forward(self, qpos, image, env_state, actions=None, is_pad=None, type=None):
        """
        qpos: batch, qpos_dim
        ...
        if self.backbones is not None:
            ...
            hs = self.transformer(src, None, self.query_embed.weight, pos, latent_input, proprio_input, self.additional_pos_embed.weight, type)[0]
        # else:
